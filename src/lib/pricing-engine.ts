...
export async function resolvePricingForCurrency(
  pricingData: {
    instagram: PricingTierInput[];
    tiktok: PricingTierInput[];
    tiktokLikes?: PricingTierInput[];
    tiktokViews?: PricingTierInput[];
    instagramLikes?: PricingTierInput[];
    instagramViews?: PricingTierInput[];
  ...
  const [instagram, tiktok, tiktokLikes, tiktokViews, instagramLikes, instagramViews] = await Promise.all([
    resolvePlatform(pricingData.instagram),
    resolvePlatform(pricingData.tiktok),
    resolvePlatform(pricingData.tiktokLikes),
    resolvePlatform(pricingData.tiktokViews),
    resolvePlatform(pricingData.instagramLikes),
    resolvePlatform(pricingData.instagramViews),
  ]);
