...
function OrderCard({ order, index }: { order: DashboardOrder; index: number }) {
  ...
  const accentColor = isInstagram ? "#dd2a7b" : "#ee1d52";
  const gradientFrom = isInstagram ? "from-pink-500" : "from-cyan-400";
  const gradientTo = isInstagram ? "to-purple-600" : "to-blue-600";
