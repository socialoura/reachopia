/* ═══════════════════════════════════════════════════════════════
   GET /api/social-profile?username=xxx&platform=instagram|tiktok
...
function fallbackProfile(username: string, platform: "instagram" | "tiktok"): SocialProfile {
  return {
    username,
    platform,
...
export async function GET(req: NextRequest) {
  try {
    ...
    if (!username || !platform || !["instagram", "tiktok"].includes(platform)) {
      return NextResponse.json(
    ...
    try {
      profile = await fetchSocialProfile(username, platform);
    } catch (err) {
